%% Based on oacd_hop by Michah Warren
%% http://github.com/OpenACD/oacd_hop
...
init(_Opts) ->
	...
	{ok, Ctxt} = erlzmq:context(),
	{ok, Sock} = erlzmq:socket(Ctxt, push),
	erlzmq:bind(Sock, "tcp://*:9872"),
...
try_send(Send, #state{socket = Sock} = State) ->
